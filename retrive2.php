	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Users with more than 3 bookings</b></p>
				</td>
				<tr>
					<th>Name</th>
					<th>Book ID</th>
				...
				<?php
					...
					$sql1 = "SELECT * from booked_hist where price > 1 group by phone having count(*)>1";
