...
<body>
	...
	<div style="background-color: white;">
		<form action="admin_signed_up.php" method="post">
			<table>
				<tr>
						<td colspan="2"><p style="font-size: 35px; font-family: 'Times New Roman', serif; color: #000;"><b>Admin SignUp</b></p></td>
				</tr>
				<tr>
					<td>User ID:</td>
				...
				<tr>
					<td colspan="2"><input style="font-size: 25px; background-color: grey; border: 1px solid #000; box-shadow: 2px 2px #a6a6a6; color: white; border-radius: 10px;" type="submit" value="Submit"></td>
				</tr>
			</table>
		</form> 
	</div>
