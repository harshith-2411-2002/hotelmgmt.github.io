...
<body>
	...
	<form action="admin_db.php" method="post">
		<table>
			<tr>
				<td colspan="2"><p style="font-size: 35px; color: #000;"><b>Admin Login</b></p></td>
			</tr>
			<tr>
	...
	<table>
		<tr><td><br></td></tr>
			<tr>
				<td style="color: #000;"><b>New Admin?</b></td>
				<td style="color: #000;"><b>Unable to Login</b></td>
			</tr>
			<tr>
				<td><button type="button"><a style="color: #000;  font-size: 25px;" href="admin_signup.php">User SignUp</a></button></td>
				<td><button type="button"><a style="color: #000; font-size: 25px;" href="admin_forgot_pwd.php">Forgot Password</a></button></td>
			</tr>
		</table>
</div>
</body>
