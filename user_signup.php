...
<body>
	...
	<div style="background-color: white;">
		<form action="user_signed_up.php" method="post">
			<table>
				<tr>
					<td colspan="2"><p style="font-size: 35px; font-family: 'Times New Roman', serif; color: #000;"><b>New User SignUp</b></p></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="input" type="text" name="phone" minlength="10" maxlength="10" placeholder="Enter Number" required></td>
				</tr>
				<tr>
				...
				<tr><td><br></td></tr>
				<tr>
					<td colspan="2"><input style="font-size: 28px; background-color: grey; border: 1px solid #a6a6a6; box-shadow: 2px 2px #a6a6a6; color: white; border-radius: 10px;" type="submit" value="Submit"></td>
				</tr>
			</table>
		</form>
	</div> 
