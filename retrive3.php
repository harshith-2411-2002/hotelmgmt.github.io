	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Users who have booked AC</b></p>
				</td>
				<tr>
					<th>Booking ID</th>
					<th>Name</th>
				...
				<?php
					...
					if($conn->connect_error)
					{
						...
						$sql1 = "SELECT * from user_room_book where ac='true'";
